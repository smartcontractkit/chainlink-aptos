...
import (
	...
	aptosseq "github.com/smartcontractkit/chainlink-aptos/deployment/ccip/sequence"
	"github.com/smartcontractkit/chainlink-aptos/deployment/subjects"
	aptosops "github.com/smartcontractkit/chainlink-aptos/deployment/ccip/operation/rmn"
...
func (c *CurseAdapter) Initialize(e cldf.Environment, selector uint64) error {
	stateMap, err := aptosstate.LoadOnchainState(e)
	if err != nil {
...
func (c *CurseAdapter) SelectorToSubject(selector uint64) fastcurse.Subject {
	return subjects.FamilyAwareSelectorToSubject(selector, chainsel.FamilyAptos)
}
