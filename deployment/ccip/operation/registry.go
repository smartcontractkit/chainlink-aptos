...
func GetAptosOperations() []*cld_ops.Operation[any, any, any] {
	...
	operations = append(operations, rmn.CurseMultipleOp.AsUntypedRelaxed())
	operations = append(operations, rmn.UncurseMultipleOp.AsUntypedRelaxed())
	operations = append(operations, rmn.InitializeAllowedCursersOp.AsUntypedRelaxed())
