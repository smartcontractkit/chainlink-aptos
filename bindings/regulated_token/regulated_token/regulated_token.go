...
type RegulatedTokenEncoder interface {
	...
	GetStore(account aptos.AccountAddress, tokenMetadata aptos.AccountAddress) (bind.ModuleInformation, string, []aptos.TypeTag, [][]byte, error)
...
func (c regulatedTokenEncoder) GetStore(account aptos.AccountAddress, tokenMetadata aptos.AccountAddress) (bind.ModuleInformation, string, []aptos.TypeTag, [][]byte, error) {
	return c.BoundContract.Encode("get_store", nil, []string{
		"address",
		"address",
	}, []any{
		account,
