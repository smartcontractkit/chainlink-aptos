...
type ManagedTokenPoolEvents struct {
}
...
func (c managedTokenPoolEncoder) InitializeTokenPoolEvents() (bind.ModuleInformation, string, []aptos.TypeTag, [][]byte, error) {
	return c.BoundContract.Encode("initialize_token_pool_events", nil, []string{}, []any{})
}

func (c managedTokenPoolEncoder) Transfer(to aptos.AccountAddress, amount uint64) (bind.ModuleInformation, string, []aptos.TypeTag, [][]byte, error) {
