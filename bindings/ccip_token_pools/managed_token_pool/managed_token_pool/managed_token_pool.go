...
type ManagedTokenPoolEncoder interface {
	...
	Initialize(administrator aptos.AccountAddress) (bind.ModuleInformation, string, []aptos.TypeTag, [][]byte, error)
...
func (c managedTokenPoolEncoder) Initialize(administrator aptos.AccountAddress) (bind.ModuleInformation, string, []aptos.TypeTag, [][]byte, error) {
