...
type OnrampInterface interface {
	...
	MigrateDestChainConfigsToV2(opts *bind.TransactOpts) (*api.PendingTransaction, error)
...
type OnrampEncoder interface {
	...
	MigrateDestChainConfigsToV2() (bind.ModuleInformation, string, []aptos.TypeTag, [][]byte, error)
...
func (c OnrampContract) MigrateDestChainConfigsToV2(opts *bind.TransactOpts) (*api.PendingTransaction, error) {
	module, function, typeTags, args, err := c.onrampEncoder.MigrateDestChainConfigsToV2()
	if err != nil {
		return nil, err
	}
...
func (c onrampEncoder) MigrateDestChainConfigsToV2() (bind.ModuleInformation, string, []aptos.TypeTag, [][]byte, error) {
	return c.BoundContract.Encode("migrate_dest_chain_configs_to_v2", nil, []string{}, []any{})
}
