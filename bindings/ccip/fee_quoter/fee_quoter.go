...
type FeeQuoterEncoder interface {
	...
	UpdatePricesInternal(sourceTokens []aptos.AccountAddress, sourceUsdPerToken []*big.Int, gasDestChainSelectors []uint64, gasUsdPerUnitGas []*big.Int) (bind.ModuleInformation, string, []aptos.TypeTag, [][]byte, error)
...
func (c FeeQuoterContract) UpdatePrices(opts *bind.TransactOpts, sourceTokens []aptos.AccountAddress, sourceUsdPerToken []*big.Int, gasDestChainSelectors []uint64, gasUsdPerUnitGas []*big.Int) (*api.PendingTransaction, error) {
	module, function, typeTags, args, err := c.feeQuoterEncoder.UpdatePrices(sourceTokens, sourceUsdPerToken, gasDestChainSelectors, gasUsdPerUnitGas)
	if err != nil {
		return nil, err
	}
...
func (c feeQuoterEncoder) UpdatePricesInternal(sourceTokens []aptos.AccountAddress, sourceUsdPerToken []*big.Int, gasDestChainSelectors []uint64, gasUsdPerUnitGas []*big.Int) (bind.ModuleInformation, string, []aptos.TypeTag, [][]byte, error) {
