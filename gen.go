...
//go:generate go run ./cmd/bindgen --input ./contracts/platform_mock/sources/mock_forwarder.move --output ./bindings/platform_mock/mock_forwarder
//go:generate go run ./cmd/bindgen --input ./contracts/platform_mock/sources/mock_storage.move --output ./bindings/platform_mock/mock_storage
