module mcms::mcms_dispatcher {
    ...
    public fun register<T: drop>(
      ...
      assert!(!smart_table::contains(&dispatcher.registered_objects, type_info), EPROOF_ALREADY_EXISTS);
  ...
  public(friend) fun insert(
    callback_address: address, callback_module_name: String, callback_function: String, data: vector<u8>): Object<Metadata> acquires Dispatcher {
  ...
  inline fun create_callback_key(callback_address: address, callback_module_name: String): vector<u8> {
