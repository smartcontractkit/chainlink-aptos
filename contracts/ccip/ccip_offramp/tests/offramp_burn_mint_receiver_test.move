#[test_only]
module ccip_offramp::offramp_burn_mint_receiver_test {
    use std::account;
    ...
    use ccip_offramp::burn_mint_dispatchable_receiver;
    ...
    fun setup_dispatchable_receiver(
        ...
        account::create_account_if_does_not_exist(signer::address_of(ccip_offramp));
        receiver_registry::init_module_for_testing(owner);
        burn_mint_dispatchable_receiver::test_init_module(ccip_offramp);
    }
    ...
    fun test_execute_non_dispatchable_token_transfer_only(
        ...
        execute_message_and_verify_success(1, test_message, vector[vector[]]);
    ...
    fun test_execute_dispatchable_token_transfer_only(
        ...
        let tokens_only_events =
            burn_mint_dispatchable_receiver::get_received_tokens_only_events();
        assert!(tokens_only_events.length() == 1);
    }
    ...
    fun test_execute_dispatchable_message_only(
        ...
        let received_events =
            burn_mint_dispatchable_receiver::get_received_message_events();
        assert!(received_events.length() == 1);

        let event = received_events.borrow(0);
        let event_message =
            burn_mint_dispatchable_receiver::received_message_get_message(event);
        assert!(event_message == string::utf8(test_data));
    }
    ...
    fun test_receiver_dispatchable_tokens_with_forwarding(
        ...
        let forwarded_events =
            burn_mint_dispatchable_receiver::get_forwarded_tokens_events();
        assert!(forwarded_events.length() == 1);
    }
    ...
    #[
        ...
        expected_failure(
            abort_code = 327689, location = burn_mint_token_pool::burn_mint_token_pool
        )
    ]
    fun test_transfer_outside_ccip_receive_fails(
        ...
        burn_mint_token_pool::transfer(ccip_offramp, @0x999, 100000);
    }
}
