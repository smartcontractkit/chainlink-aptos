...
module ccip::eth_abi {
  ...
  public inline fun encode_bytes32(out: &mut vector<u8>, value: vector<u8>) {
  ...
  public inline fun encode_packed_address(out: &mut vector<u8>, value: address) {
    vector::append(out, bcs::to_bytes(&value))
  }

  public inline fun encode_packed_bytes(out: &mut vector<u8>, value: vector<u8>) {
    vector::append(out, value)
  }

  public inline fun encode_packed_bytes32(out: &mut vector<u8>, value: vector<u8>) {
