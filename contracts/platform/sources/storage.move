...
module chainlink_platform::storage {
    ...
    struct Dispatcher has key {
        id: UID,
        dispatcher: Table<TypeInfo, address>,
    ...
    public fun register<T: drop>(
        ...
        let type_name = types::get_type_name<T>();
        ...
        let entry_address = object::id_address(&entry);
    ...
    public fun storage_exists(obj_address: address): bool {
