module platform_secondary::forwarder {
    ...
    #[test(owner = @owner, publisher = @platform_secondary)]
    ...
    #[test(owner = @owner, publisher = @platform_secondary, new_owner = @0xbeef)]
    ...
    #[test(owner = @owner, publisher = @platform_secondary, unknown_user = @0xbeef)]
