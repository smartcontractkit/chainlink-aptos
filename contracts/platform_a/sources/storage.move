...
module platform_a::storage {
    ...
    fun test_v2_migration(publisher: &signer) acquires Dispatcher, DispatcherV2, Storage {
        ...
        // test initial migration
        {
            ...
            migrate_to_v2(vector[@platform_a, derived_addr]);
            ...
            assert!(!table::contains(&dispatcher.address_to_typeinfo, @platform_a), 1);
            assert!(
                !table::contains(
            ...
            assert!(
                smart_table::contains(&dispatcher_v2.address_to_typeinfo, @platform_a),
                1
            );
            assert!(
                smart_table::contains(
