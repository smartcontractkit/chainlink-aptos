...
require (
	...
	github.com/smartcontractkit/chainlink/deployment v0.0.0-20260407130455-5258160d170f
	github.com/smartcontractkit/chainlink/v2 v2.32.0
	github.com/smartcontractkit/libocr v0.0.0-20260403184524-b6409238958d
	github.com/smartcontractkit/mcms v0.53.0
...
require (
	...
	github.com/smartcontractkit/quarantine v0.0.0-20251203215908-fd0551c6adf9 // indirect
...
// Copied from chainlink/v2/go.mod
...
replace (
	...
	// chainlink-evm embedded defaults use uint64-max literals; go-toml/v2.4+ rejects them as int64
	github.com/pelletier/go-toml/v2 => github.com/pelletier/go-toml/v2 v2.2.4
	...
	// chainlink-evm codecgen requires ugorji v1.2.x API (GenVersion/GenHelper removed in v1.3+)
...
// Pin chainlink-sui to CLDF v0.110.0; keep deployment on the older ISuiAPI-compatible release.
replace (
	github.com/smartcontractkit/chainlink-sui => github.com/smartcontractkit/chainlink-sui v0.0.0-20260527160341-aa3adc0abf67
	github.com/smartcontractkit/chainlink-sui/deployment => github.com/smartcontractkit/chainlink-sui/deployment v0.0.0-20260304150206-c64e48eb0cb0
)

replace github.com/smartcontractkit/chainlink-ccip/deployment => github.com/smartcontractkit/chainlink-ccip/deployment v0.0.0-20260415165642-49f23e4d76cc

replace github.com/smartcontractkit/chainlink-ccip/chains/evm => github.com/smartcontractkit/chainlink-ccip/chains/evm v0.0.0-20260415165642-49f23e4d76cc

replace github.com/smartcontractkit/chainlink-ton/deployment => github.com/smartcontractkit/chainlink-ton/deployment v0.0.0-20260520103847-15ca4de9dba9

replace github.com/smartcontractkit/chainlink/v2 => github.com/smartcontractkit/chainlink/v2 v2.29.1-cre-beta.0.0.20260407130455-5258160d170f

replace github.com/smartcontractkit/chainlink/core/scripts => github.com/smartcontractkit/chainlink/core/scripts v0.0.0-20260407130455-5258160d170f

replace github.com/smartcontractkit/chainlink/deployment => github.com/smartcontractkit/chainlink/deployment v0.0.0-20260407130455-5258160d170f
